...
{
	public sealed class FakeDataStore
	{
        ...
        private void SetNewRestaurants()
        {
			...
			newRestaurant.OpenHour = DateTime.Now.SetTime(8, 0);
			newRestaurant.CloseHour = DateTime.Now.SetTime(18, 0);
            ...
            newRestaurant2.OpenHour = DateTime.Now.SetTime(11, 0);
            newRestaurant2.CloseHour = DateTime.Now.SetTime(21, 0);
